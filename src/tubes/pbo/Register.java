...
import static tubes.pbo.Login.conn;
...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        verif_dialog.setMinimumSize(new java.awt.Dimension(229, 108));
        verif_dialog.setSize(new java.awt.Dimension(260, 140));
    ...
    private void simpan_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpan_buttonActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO pasien VALUES('"+id+"','"+nama+"','"+email+"','"+username+"','"+password+"','"+tgl_lahir+"','"+alamat+"','"+keluhan_id+"')";
