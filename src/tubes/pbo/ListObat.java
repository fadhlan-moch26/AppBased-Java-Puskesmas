...
public class ListObat extends javax.swing.JFrame {
    ...
    public ListObat() {
        ...
        String[] temp = new String[arr_obat.size()];
        for ( int i = 0; i < arr_obat.size(); i ++ ) {
            temp[i] = arr_obat.get(i).getNama_obat();
        }
        list_obat.setListData(temp);
        list_obat.addListSelectionListener((e) -> {
            String nama = arr_obat.get(list_obat.getSelectedIndex()).getNama_obat();
            int keluhan_id = arr_obat.get(list_obat.getSelectedIndex()).getKeluhan_id();
            String deskripsi = arr_keluhan.get(keluhan_id-1).getNama_keluhan();
            String harga = Integer.toString(arr_obat.get(list_obat.getSelectedIndex()).getHarga());
            label_nama.setText(nama);
            label_keluhan.setText(deskripsi);
            label_harga.setText("Rp "+harga);
        });
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tutup_button, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(32, 32, 32)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
